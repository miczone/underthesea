...
class DependencyParserExtend(underthesea.models.modules.nn.Model):
    r"""
    ...
    def __init__(
        ...
        super(DependencyParserExtend, self).__init__()
        self.embed = embed
        self.feat = feat
        ...
        # the embedding layer
        token_embeddings = self.embeddings.embeddings[0]
        self.word_embed = nn.Embedding(num_embeddings=token_embeddings.n_words,
    ...
    def forward(self, words, feats):
        ...
        pad_index = self.embeddings.embeddings[0].pad_index
