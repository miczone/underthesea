...
class DependencyParserTrainerExtend:
    ...
    def train(
        ...
        stack_embeddings = self.parser.embeddings
        token_embeddings = stack_embeddings.embeddings[0]
        token_embeddings.n_words = WORD.vocab.n_init
        token_embeddings.pad_index = WORD.pad_index
        token_embeddings.unk_index = WORD.unk_index
        stack_embeddings.embeddings[0] = token_embeddings

        parser = DependencyParserExtend(
            n_feats=args.n_feats,
            n_rels=args.n_feats,
            # bos_index=args.bos_index,
            feat_pad_index=args.feat_pad_index,
            transform=transform,
            embeddings=stack_embeddings
        )
